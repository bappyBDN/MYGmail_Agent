...
![Live Inbox View](path/to/frontend_1.png) ### 2. 🧠 AI Generation via RAG & LLM
...
![Database Workflow](path/to/DBworkflow.png) ### 3. 🧑‍💻 Human-in-the-Loop & Rating System
...
![Draft Review & Feedback](path/to/frontend_2.png) ### 4. 🚀 Dispatching the Email
...
![Client Email View](path/to/client_mail.png) ### 5. 📊 Performance & Analytics Tracking
...
![Analytics Dashboard](path/to/frontend_3.png) <br>
*Database structure mapping the feedback loop:*
![Database Tables](path/to/db_table.png) 
